...
## Components
Cards use rounded 20px, translucent surfaces, thin borders, and compact dense content. Status pills must be color-coded. Tables should be readable on mobile via horizontal scroll.
